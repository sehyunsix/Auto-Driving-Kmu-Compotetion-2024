...
def start():
    ...
    while not rospy.is_shutdown():
        ...
        if(len(lidarDriver.obstacle_list)>0 and labacon_mode==False and greenCount>=400):
        ...
        if labacon_mode:
            ...
            if(stack>30 ):
                ...
                stack=0
                speed=10
                # for i in range(3):# elif obstacle_mode:
        #     print("================= ObstacleMode ===================")
        #     if(lidardegree<0):
        ...
        elif obstacle_mode and pass_labacon_mode==True and greenCount>=500:
            print("================= ObstacleMode ===================")
            if(lidardegree<0):
                ObstacleAvoidance(-1)
                print("left")
